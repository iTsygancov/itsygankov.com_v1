...
category: Next.js
description: Learn how to add syntax highlighting to your markdown files in a Next.js application, using a library such as highlight.js.
keywords: ["Next.js", "syntax highlighting", "markdown", "highlight.js", "web development", "javascript"]
---
...
- __Markdown files that are static__. We'll only be using local.md files from your Next.js project for this tutorial.
...
You require a functioning Next.js app with a page on which you want to load the Markdown content before you can proceed. <a href="https://nextjs.org/docs/api-reference/create-next-app" target="_blank"><strong>Create Next App</strong></a> can help you launch a beginner project if you're starting from scratch. Install the dependencies we'll need once this is ready.

```bash
npm i --save next-mdx-remote rehype-highlight
```

__Highlight.js or Prism?__ Although all solutions have advantages, we'll be utilizing Highlight.js for this example. Simply swap out `@mapbox/rehype-prism` for `rehype-highlight` if you wish to use Prism instead, and then use the Prism stylesheets in place of the linked Highlight.js stylesheets.
