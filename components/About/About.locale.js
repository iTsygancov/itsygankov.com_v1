...
const ru = {
  title: 'Обо мне',
  descriptionText: [
    'Я Front-End разработчик, живущий в Москве. Серьезно увлекаюсь созданием интуитивно понятного, динамичного пользовательского интерфейса, веб дизайном и анимацией.',
    'Хорошо организованный человек, решающий проблемы, работник с высоким вниманием к деталям. Любитель активного отдыха, сериалов и музыки. Семейный человек и отец одной непоседливой девочки. Интересуюсь всем спектром фронтенда и работой над амбициозными проектами с позитивными людьми.',
  ],
