const en = {
  ...
  link: 'Take me back to home page',
};

const ru = {
  title: 'Вы нашли тайное место',
  description: 'К сожалению, это всего лишь страница 404. Возможно, вы неправильно ввели адрес, или страница была перемещена на другой URL.',
